...
export class Backend implements backendInterface {
    ...
    async addProduct(arg0: string, arg1: string, arg2: string, arg3: string, arg4: string): Promise<Product> {
    ...
    async submitOrder(arg0: bigint, arg1: string, arg2: string, arg3: string, arg4: bigint): Promise<Order> {
        if (this.processError) {
            try {
